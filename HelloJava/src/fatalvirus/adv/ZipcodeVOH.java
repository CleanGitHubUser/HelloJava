...
public class ZipcodeVOH {
	...
	public ZipcodeVOH(int no, String 우편번호, String 시도, String 시군구, String 읍면, String 도로명, String 건물번호본번, String 건물번호부번,
	...
	public String toString() {
		String fmt = "ZipcodeVOH [no=%d, 우편번호=%d, 시도=%s, 시군구=%s, 읍면=%s, 도로명=%s, 건물번호본번=%d, 건물번호부번=%d, 시군구용건물명=%s, 법정동명=%s, 리명=%s, 지번본번=%d]";
		return String.format(fmt, no, 우편번호, 시도, 시군구, 읍면, 건물번호본번, 건물번호부번, 시군구용건물명, 법정동명, 리명, 지번본번);
	}
